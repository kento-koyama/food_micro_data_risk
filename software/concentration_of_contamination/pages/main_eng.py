...
df = df.loc[:, ['Year', 'Food Category', 'Food Name', 'Food details', 'Organism', 'Organism_Detail', 'Organism_LaTeX', 'method', 'log CFU/g', 'MPN per g', 'Concentration', 'Unit', 'Agency', 'Survey', 'Source URL', 'Access Date', 'detail information']]
...
if edible_only:
    if 'Food Name' in df_filtered.columns:
        ...
        df_filtered = df_filtered[~(df_filtered['Food Name'].astype(str).str.contains("Cutaneous swabs", case=False, na=False))]
